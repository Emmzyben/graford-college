...
<p>Enter your exam number in the registration number box and click search to check status.</p>
</div>
...
<input type="text" name="examNumber" placeholder="Enter exam number">
<input type="submit"  id="" value="Go!" style="background-color: #e94d1c;border:0px solid black">
     </form>
     <br> 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlSelect = "SELECT fullName, matriculationNumber FROM admissions WHERE examNumber = ?";
    ...
    if ($stmtSelect = $conn->prepare($sqlSelect)) {
        ...
        $stmtSelect->bind_result($fullName, $matriculationNumber);
        ...
        if ($stmtSelect->fetch()) {
            ...
            echo "<h3>Congratulations $fullName ,you are admitted.</h3><br>";
            echo "<p><b>Your Matriculation Number is:<span style='color:blue'> $matriculationNumber </span>,You can now use it to login to the student dashboard. <br> Your login password was sent to your email</b></p><br>";
