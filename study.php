...
<header id="cover">
    ...
    <aside >
        ...
        <div style="text-ali\gn: center;padding-top: 15px;color: #090970;padding-left: 20px;"><h3>GRAF-COMAS</h3></div>
...
<div class="post-container"> 
  <h1 id="topper">Study articles and materials</h1>
  <ul>
      <?php
while ($row = mysqli_fetch_assoc($result)) {
    echo "<li id='cool'>";
    echo "<div id='cooler'>";
    echo "<h1 id='color'><b>" . $row['postTitle'] . "</b></h1>";
    
    // Use nl2br to handle newlines in the postContent
    echo "<p>" . nl2br($row['postContent']) . "</p>";
    
    echo "</div>";
    
    if (!empty($row['picture_path'])) {
        echo "<img src='" . $row['picture_path'] . "' alt='Post Image' id='img'>";
    }
